    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.DecimalField(blank=True, decimal_places=2, help_text='the cost per recurrence of the plan', max_digits=19, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_cost', models.ForeignKey(help_text='the plan costs and billing frequency for this user', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions', to='subscriptions_api.PlanCost')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.ForeignKey(help_text='the Subscription that were billed', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transactions', to=swapper.get_model_name('subscriptions_api', 'UserSubscription'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, help_text='any tags associated with this plan', related_name='plans', to='subscriptions_api.PlanTag')),
            ],
            options={
                'ordering': ('plan_name',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plan_list_details', to='subscriptions_api.SubscriptionPlan')),
                ('plan_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plan_list_details', to='subscriptions_api.PlanList')),
            ],
        ),
        migrations.AddField(
            model_name='plancost',
            name='plan',
            field=models.ForeignKey(help_text='the subscription plan for these cost details', on_delete=django.db.models.deletion.CASCADE, related_name='costs', to='subscriptions_api.SubscriptionPlan'),
        ),
    ]
